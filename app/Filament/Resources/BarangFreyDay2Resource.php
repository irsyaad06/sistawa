...
use App\Filament\Resources\BarangFreyDay2Resource\Pages;
use App\Filament\Resources\BarangFreyDay2Resource\RelationManagers;
...
class BarangFreyDay2Resource extends Resource
{
    protected static ?string $model = BarangFreyDay2::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Frey Day 2';
    ...
    {
        return [
            'index' => Pages\ListBarangFreyDay2s::route('/'),
            'create' => Pages\CreateBarangFreyDay2::route('/create'),
            'edit' => Pages\EditBarangFreyDay2::route('/{record}/edit'),
        ];
    }
