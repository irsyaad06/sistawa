...
use App\Filament\Resources\BarangBaratheonDay2Resource\Pages;
use App\Filament\Resources\BarangBaratheonDay2Resource\RelationManagers;
use App\Models\BarangBaratheonDay2;
...
class BarangBaratheonDay2Resource extends Resource
{
    protected static ?string $model = BarangBaratheonDay2::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Baratheon Day 2';
    ...
    {
        return [
            'index' => Pages\ListBarangBaratheonDay2s::route('/'),
            'create' => Pages\CreateBarangBaratheonDay2::route('/create'),
            'edit' => Pages\EditBarangBaratheonDay2::route('/{record}/edit'),
        ];
    }
