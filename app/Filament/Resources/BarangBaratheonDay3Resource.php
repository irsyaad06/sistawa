...
use App\Filament\Resources\BarangBaratheonDay3Resource\Pages;
use App\Filament\Resources\BarangBaratheonDay3Resource\RelationManagers;
...
class BarangBaratheonDay3Resource extends Resource
{
    protected static ?string $model = BarangBaratheonDay3::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Baratheon Day 3';
    ...
    {
        return [
            'index' => Pages\ListBarangBaratheonDay3s::route('/'),
            'create' => Pages\CreateBarangBaratheonDay3::route('/create'),
            'edit' => Pages\EditBarangBaratheonDay3::route('/{record}/edit'),
        ];
    }
