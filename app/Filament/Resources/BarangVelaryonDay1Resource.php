...
use App\Filament\Resources\BarangVelaryonDay1Resource\Pages;
use App\Filament\Resources\BarangVelaryonDay1Resource\RelationManagers;
use App\Models\BarangVelaryonDay1;
...
class BarangVelaryonDay1Resource extends Resource
{
    protected static ?string $model = BarangVelaryonDay1::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Velaryon Day 1';
    ...
    {
        return [
            'index' => Pages\ListBarangVelaryonDay1s::route('/'),
            'create' => Pages\CreateBarangVelaryonDay1::route('/create'),
            'edit' => Pages\EditBarangVelaryonDay1::route('/{record}/edit'),
        ];
    }
