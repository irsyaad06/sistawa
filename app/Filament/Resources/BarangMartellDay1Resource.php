...
use App\Filament\Resources\BarangMartellDay1Resource\Pages;
use App\Filament\Resources\BarangMartellDay1Resource\RelationManagers;
...
class BarangMartellDay1Resource extends Resource
{
    protected static ?string $model = BarangMartellDay1::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Martell Day 1';
    ...
    {
        return [
            'index' => Pages\ListBarangMartellDay1s::route('/'),
            'create' => Pages\CreateBarangMartellDay1::route('/create'),
            'edit' => Pages\EditBarangMartellDay1::route('/{record}/edit'),
        ];
    }
