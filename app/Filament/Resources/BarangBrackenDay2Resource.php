...
use App\Filament\Resources\BarangBrackenDay2Resource\Pages;
use App\Filament\Resources\BarangBrackenDay2Resource\RelationManagers;
...
class BarangBrackenDay2Resource extends Resource
{
    protected static ?string $model = BarangBrackenDay2::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Bracken Day 2';
    ...
    {
        return [
            'index' => Pages\ListBarangBrackenDay2s::route('/'),
            'create' => Pages\CreateBarangBrackenDay2::route('/create'),
            'edit' => Pages\EditBarangBrackenDay2::route('/{record}/edit'),
        ];
    }
