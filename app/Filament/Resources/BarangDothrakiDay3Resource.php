...
use App\Filament\Resources\BarangDothrakiDay3Resource\Pages;
use App\Filament\Resources\BarangDothrakiDay3Resource\RelationManagers;
...
class BarangDothrakiDay3Resource extends Resource
{
    protected static ?string $model = BarangDothrakiDay3::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Dothraki Day 3';
    ...
    {
        return [
            'index' => Pages\ListBarangDothrakiDay3s::route('/'),
            'create' => Pages\CreateBarangDothrakiDay3::route('/create'),
            'edit' => Pages\EditBarangDothrakiDay3::route('/{record}/edit'),
        ];
    }
