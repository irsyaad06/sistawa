...
use App\Filament\Resources\BarangMartellDay3Resource\Pages;
use App\Filament\Resources\BarangMartellDay3Resource\RelationManagers;
...
class BarangMartellDay3Resource extends Resource
{
    protected static ?string $model = BarangMartellDay3::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Martell Day 3';
    ...
    {
        return [
            'index' => Pages\ListBarangMartellDay3s::route('/'),
            'create' => Pages\CreateBarangMartellDay3::route('/create'),
            'edit' => Pages\EditBarangMartellDay3::route('/{record}/edit'),
        ];
    }
