...
use App\Filament\Resources\BarangTyrellDay1Resource\Pages;
use App\Filament\Resources\BarangTyrellDay1Resource\RelationManagers;
use App\Models\BarangTyrellDay1;
...
class BarangTyrellDay1Resource extends Resource
{
    protected static ?string $model = BarangTyrellDay1::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Tyrell Day 1';
    ...
    {
        return [
            'index' => Pages\ListBarangTyrellDay1s::route('/'),
            'create' => Pages\CreateBarangTyrellDay1::route('/create'),
            'edit' => Pages\EditBarangTyrellDay1::route('/{record}/edit'),
        ];
    }
