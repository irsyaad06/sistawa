...
use App\Filament\Resources\BarangFreyDay1Resource\Pages;
use App\Filament\Resources\BarangFreyDay1Resource\RelationManagers;
use App\Models\BarangFreyDay1;
use Filament\Forms;
...
class BarangFreyDay1Resource extends Resource
{
    protected static ?string $model = BarangFreyDay1::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $pluralModelLabel = 'Barang Frey Day 1';
    ...
    {
        return [
            'index' => Pages\ListBarangFreyDay1s::route('/'),
            'create' => Pages\CreateBarangFreyDay1::route('/create'),
            'edit' => Pages\EditBarangFreyDay1::route('/{record}/edit'),
        ];
    }
